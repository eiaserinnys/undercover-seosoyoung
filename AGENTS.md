...
CLI: this project keeps runtime packages only. Run CLI docs with `npx -y --package @astryxdesign/cli@0.1.2 astryx <cmd>` unless the project later adds `@astryxdesign/cli` as a devDependency.
